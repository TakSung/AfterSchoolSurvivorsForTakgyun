...
class SpawnResult:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.spawn_position, tuple) or len(self.spawn_position) != 2:
            raise ValueError("spawn_position must be a tuple of (x, y) coordinates")
        ...
        if not isinstance(self.difficulty_scale, (int, float)) or self.difficulty_scale <= 0:
