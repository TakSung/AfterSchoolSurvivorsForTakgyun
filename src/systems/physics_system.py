...
class PhysicsSystem(System):
    ...
    def calculate_friction(
        self, velocity: np.ndarray, friction_coefficient: float
    ) -> np.ndarray:
        """
        ...
        friction_force = (
            friction_direction * friction_coefficient * velocity_magnitude
        )
    ...
    def vector_multiply(
        self, vector: tuple[float, float], scalar: float
    ) -> tuple[float, float]:
        """
